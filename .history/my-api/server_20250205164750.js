...
app.all("*", function (req, res) {
  ...
  res.header(
    ...
    "http://127.0.0.1:5500/demo-6.7.0/index.html#/edit/0"
  ); //此时表示：允许 'http://127.0.0.1:5500' 地址来访问服务器；
  res.header("Access-Control-Allow-Methods", "GET,POST"); //此时表示：允许发的请求方式，如：'GET,POST,PUT';
